...
from .views import acceptInvitations, rejectInvitations, remove_from_friends, send_invitation,my_profile_view, invites_received_view,profiles_list_view, invite_profiles_list_view, ProfilelistView
